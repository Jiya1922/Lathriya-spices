...
SOCIALACCOUNT_ADAPTER = 'spices.adapter.CustomSocialAccountAdapter'
...
# Session & Cookie Security for OAuth HTTPS Redirects
...
# Dual Email Configuration (Gmail SMTP & Resend)
EMAIL_PROVIDER = os.getenv('EMAIL_PROVIDER', 'smtp').strip().lower() # 'smtp' or 'resend'
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', f'Lathriya Spices <{EMAIL_HOST_USER}>' if EMAIL_HOST_USER else 'Lathriya Spices <lathriyaspices@gmail.com>')

# Resend API Configuration
RESEND_API_KEY = os.getenv('RESEND_API_KEY', '').strip()
RESEND_FROM_EMAIL = os.getenv('RESEND_FROM_EMAIL', 'Lathriya Spices <onboarding@resend.dev>').strip()
